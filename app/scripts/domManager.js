define([
    ...
    DomManager.prototype.createLabelHtml = function(model) {
        ...
        var tile = model.tileCache[model.zoom],
            ...
            multiline = _.map(this.toMultiLines(name, 12), function(line) { return line}).join("<br/>"),
        ...
        return "<div class='location " + details + highlight + labelClasses + "' style='top: " + px(offset.y - iconSize.height/2) + "; left: " + px(offset.x - iconSize.width/2) + ";' id='" + id + "'><div class='icon' style='" + iconStyle + "'></div><div class='bd'><div class='txt '>" + multiline + "<div class='more'>more &gt;</div></div><div class='thumb'>" + img + "</div></div></div>";
