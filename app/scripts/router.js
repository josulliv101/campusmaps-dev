...
// 'latlng', ,  'highlight'
        urlAttrWhiteList = ['highlight', 'tile'], //['featured', 'query', 'querytype', 'customcampusmap', 'centeroffset', 'photowide', 'satellite', 'cmd', 'campusid', 'campusmap', 'locs', 'locationid', 'details', 'detailsview', 'vizpath!', 'zoom'], // 'vizpath',
