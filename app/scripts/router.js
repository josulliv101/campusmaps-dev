...
define([
    ...
    var settingsUrl,
        ...
        urlAttrWhiteList = ['customcampusmap', 'centeroffset', 'photowide', 'satellite', 'tile', 'cmd', 'campusid', 'campusmap', 'locs', 'locationid', 'details', 'detailsview', 'vizpath!', 'zoom', 'latlng', 'highlight'], // 'vizpath',
